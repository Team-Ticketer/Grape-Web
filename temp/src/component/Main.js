...
import concertIdol from '../assets/concert-idol.png';
...
const Main = () => {
    ...
    return (
        <div className="main--wrapper">
            <img src={concertIdol} alt="" className="main--background-img"/>
                    ...
                    <div className="main--ticket--submit--box">
                        <div className="main--ticket--submit--box--inner">
                            ...
                            <div className="main--ticket--submit--button">
                                <img src={search} alt="search button" className="main--ticket--submit--button--img"/>
                            </div>
                            <div className="main--ticket--submit--empty"></div>
                        </div>
                    </div>
